...
POST_SCRIPT  = 'post_process_folded.py'
...
def _wrapper_text(csv_num, base_dir, target_script):
    ...
    # io.open takes `encoding` on both Abaqus 2017 (Py2.7) and 2024 (Py3);
    # the builtin open() only accepts it on Py3.
    return (
        "# Auto-generated MBO wrapper -- do not edit by hand.\n"
        "import io\n"
        "csv_num = %d\n" % csv_num
        + "BASE_DIR = r'%s'\n" % base_dir
        + "with io.open(r'%s', 'r', encoding='utf-8') as _f:\n" % target_script
